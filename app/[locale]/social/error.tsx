...
export default function SocialError({
  ...
  useEffect(() => {
    if (process.env.NODE_ENV === 'development') {
      console.error('[Social error boundary]', error)
    }
  }, [error])
  ...
  return (
    <div className="min-h-[50vh] flex flex-col items-center justify-center gap-6 px-6 py-16 text-center">
      <div className="max-w-md space-y-2">
        <h1 className="text-xl font-semibold text-neutral-900 dark:text-white">Sosial bölmədə xəta oldu</h1>
        <p className="text-sm text-neutral-600 dark:text-neutral-400">
          Qalan bölmələr aktivdir. Buranı yenidən cəhd edin və ya ana səhifəyə keçin.
        </p>
      </div>
