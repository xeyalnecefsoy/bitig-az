  ...
  return (
    <div className="min-h-[50vh] flex flex-col items-center justify-center gap-6 px-6 py-16 text-center">
      <div className="max-w-md space-y-2">
        <h1 className="text-xl font-semibold text-neutral-900 dark:text-white">Profil bölməsində xəta oldu</h1>
        <p className="text-sm text-neutral-600 dark:text-neutral-400">
          Digər əsas özəlliklər işləməyə davam edir. Yenidən cəhd edin və ya ana səhifəyə qayıdın.
        </p>
      </div>
